...
% This is for 99 taus, as R1 suggested
% Haoyang Liu
% 8/8/2018
...
opts = optimoptions('ga', 'MaxGenerations',5000,'PopulationSize',500,'display','iter');%'UseParallel',true,
...
%% 4) MLE
      ...
      %% 5) Save the result
save Ye_GA_3mix_3_par_nb_100_1

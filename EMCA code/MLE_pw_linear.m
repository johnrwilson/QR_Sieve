...
% Haoyang Liu
% On 12/5 added a truth-start section
% 12/5/2017
...
%% 4) MLE
     ...
     % On 12/5, commented the following two lines, and used truth as start
     % [c_start, beta_start] = pc_pl(squeeze(recorder_qreg(j_iter,:)), 3, (ntau+1));
     % start = [c_start, beta_start, para_dist_default];  
     [c_start, beta_start] = pc_pl(recorder_truth, 3, (ntau+1));

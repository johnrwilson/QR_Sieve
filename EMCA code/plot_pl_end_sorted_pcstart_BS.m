...
close all 
  ...
  %%% Part A) Set Parameters and Load Data
    % 80 White 10 tau
    % load  pl_end_Angrist80_sub1_ntau10_white1
    % 90 White 10 tau
    % load pl_end_Angrist90_sub1_ntau10_white1 
    % 00 White 15 tau
    % load pl_end_Angrist00_sub1_ntau15_white1 
    % 10 White 15 tau
    load RData_pl_end_Jacob10_sub1_ntau15_white1
    ...
    ntau = ntau + 1;
    postfixdata = 'Jacob 10 (White)'; % Jacob 10
  %%% End of Part A)
  ...
  %%% Part F) Plotting
   ...
   %%% Part G) Save the result 
    save pl_end_Jacob10_sub1_ntau15_white1 taugrid_qreg beta_qreg beta_WLS_start_sorted beta_pc_s

% Function gradl_CDF_nopre_GA
% In this version, I try to change the parameters from the slopes to the level
% 3/9/2018
function [cdf_lf] = gradl_CDF_nopre_GA(para, ParameterDist_nopre, taugrid, nmixtures, nocovar, Y, X)

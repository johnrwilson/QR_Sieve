...
for j = [1:n_repeatsample]   
    ...
    for j_WLS = 1 : 200
        ...
        [beta_WLS_start_sorted,V_WLS_start] = sortbeta_1(X_mean,betahat',ntau,ncovar);
        beta_WLS_start_sorted = beta_WLS_start_sorted';
        betahatMatrix(:,:,j_WLS,j) = beta_WLS_start_sorted;
        
        if sum(sum(betahat ~= beta_WLS_start_sorted))
            j_WLS
            
        end
        
        
        ehat=Y-X*beta_WLS_start_sorted;

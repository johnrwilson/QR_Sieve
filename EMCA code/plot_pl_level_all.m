...
for j_iter = [1:10]
    plot(taugrid_qreg,beta2_qreg_start(j_iter,:),'r--');
end


legend('Truth', 'Quantile Regression','Piecewise Linear MLE after truth'); 
title('Average Beta 2 Estimates')
print('-dpng','-r0','beta2_l_pl_truth_all');

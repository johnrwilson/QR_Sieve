...
function [lf,g] = gradl_Lei(para_Pre, taugrid, nmixtures, yt, X)
...
para = vec2mat(para_Pre(nocovar+1:ncbeta*nocovar), (ncbeta-1));
...
[lf, g] = gradl_nopre_Lei(para, ParameterDist_nopre, taugrid, nmixtures, nocovar, nsample, yt, X);

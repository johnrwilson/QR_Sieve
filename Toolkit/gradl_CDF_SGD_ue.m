...
function [cdf_lf,cdf_g] = gradl_CDF_SGD_ue(para_GA, taugrid, nmixtures, Y, X)
    ...
    % A-1) Convert step increase in para_GA to slope in para_Pre used in
    % gradl_CDF_ue_free_lambdas
    ...
    [cdf_lf,cdf_g_new] = gradl_CDF_ue_free_lambdas(para_Pre, taugrid, nmixtures, Y, X);
